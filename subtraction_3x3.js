...
const nextQuestion = () => {
  ...
  if (currentQuestion <= totalQuestions) {
    ...
    if (!localStorage.getItem('time_data_s33')) {
      localStorage.setItem('time_data_s33', '[]');
    }
    let oldTime = JSON.parse(localStorage.getItem('time_data_s33'));
    oldTime.push(newTime);
    localStorage.setItem('time_data_s33', JSON.stringify(oldTime));
...
function displayTimeTable() {
  if (localStorage.getItem('time_data_s33')) {
    let timeArray = JSON.parse(localStorage.getItem('time_data_s33'));
...
function resetQuizButton() {
  ...
  localStorage.removeItem('time_data_s33');
...
function updateGraphData() {
  ...
  let graphData = JSON.parse(localStorage.getItem('time_data_s33')) || [];
