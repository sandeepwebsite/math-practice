...
const nextQuestion = () => {
  ...
  if (currentQuestion <= totalQuestions) {
    ...
    if (!localStorage.getItem('time_data_sqrt')) {
      localStorage.setItem('time_data_sqrt', '[]');
    }
    let oldTime = JSON.parse(localStorage.getItem('time_data_sqrt'));
    oldTime.push(newTime);
    localStorage.setItem('time_data_sqrt', JSON.stringify(oldTime));
...
function displayTimeTable() {
  if (localStorage.getItem('time_data_sqrt')) {
    let timeArray = JSON.parse(localStorage.getItem('time_data_sqrt'));
...
function resetQuizButton() {
  ...
  localStorage.removeItem('time_data_sqrt');
...
function updateGraphData() {
  ...
  let graphData = JSON.parse(localStorage.getItem('time_data_sqrt')) || [];
