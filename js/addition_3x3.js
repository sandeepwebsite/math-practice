...
const nextQuestion = () => {
  ...
  if (currentQuestion <= totalQuestions) {
    ...
    if (!localStorage.getItem('time_data_a33')) {
      localStorage.setItem('time_data_a33', '[]');
    }
    let oldTime = JSON.parse(localStorage.getItem('time_data_a33'));
    oldTime.push(newTime);
    localStorage.setItem('time_data_a33', JSON.stringify(oldTime));
...
function displayTimeTable() {
  if (localStorage.getItem('time_data_a33')) {
    let timeArray = JSON.parse(localStorage.getItem('time_data_a33'));
...
function resetQuizButton() {
  ...
  localStorage.removeItem('time_data_a33');
...
function updateGraphData() {
  ...
  let graphData = JSON.parse(localStorage.getItem('time_data_a33')) || [];
